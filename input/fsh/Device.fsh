Profile: DeviceBM
Parent: Device
Description: "Este perfil corresponde a el recurso de de Dispositivo Médico de la Guía de Implementación para interoperabilidad con equipos médicos de la empresa Bluemedical Chile, y representa un monitor multiparamétrico"
